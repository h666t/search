...
var removeHttp = function removeHttp(url) {
  return url.replace("http://", "").replace("https://", "").replace("www.", "").replace(/\/.*/, "").replace(/\.\w*/, "");
};
...
var render = function render() {
  ...
  hashTable.forEach(function (node, index) {
    ...
    $li.on("click", ".close", function (event) {
      ...
      var x = localStorage.setItem("stringHashTable", stringHashTable); //立即更新localStorage，解决删除后不能及时将数据存储到localStorage
...
//# sourceMappingURL=main.12aea753.js.map